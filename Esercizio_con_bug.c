...
} // manca  " return; " alla fine della funzione void


void moltiplica ()
{
        short int  a,b = 0; // Errore: viene specificato due volte il tipo di variabile; per la casistica in questione è indicato il tipo int
        ...
        short int prodotto = a * b; // Errore: viene specificato due volte il tipo di variabile; per la casistica in questione è consigliabile il tipo int
...
void ins_string () 
{
        ...
        scanf ("%s", &stringa); // manca una funzione di stampa che conferma l'inserimento della stringa proposta dall'utente
